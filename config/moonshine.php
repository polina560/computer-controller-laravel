...
return [
    ...
    // Default user
    'default_username' => env('MOONSHINE_USERNAME', 'admin@example.com'),
    'default_name' => env('MOONSHINE_NAME', 'Admin'),
    'default_password' => env('MOONSHINE_PASSWORD', '111111'),
